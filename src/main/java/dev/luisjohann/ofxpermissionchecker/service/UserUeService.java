...
public class UserUeService {
    ...
    public List<UeUserCanAccessDTO> findAllUesFromUserEmail(String email) {
        var allowUes = userUeRepository.findByUserEmail(email);

        return UserUeMapper.INSTANCE.entityToUeUserCanAccessListDTO(allowUes);
    }
